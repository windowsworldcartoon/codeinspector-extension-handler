...
### Prerequisites
1. Ensure you're logged into NPM with @windowsworldcartoon scope
2. Verify: `npm whoami`
...
npm view @windowsworldcartoon/codeinspector-extension-handler
```
...
1. **Verify**: Check package on https://www.npmjs.com/package/@windowsworldcartoon/codeinspector-extension-handler
2. **Test**: Install in test project: `npm install @windowsworldcartoon/codeinspector-extension-handler`
...
- Users install with: `npm install @windowsworldcartoon/codeinspector-extension-handler`
...
- NPM Package: https://www.npmjs.com/package/@windowsworldcartoon/codeinspector-extension-handler
