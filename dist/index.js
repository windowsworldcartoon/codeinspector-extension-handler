...
class Extension {
  ...
  showOutput(title = 'Output') {
    return this.api.showOutput(title);
  }

  /**
   * Add a line to the output dialog
   * @param {string} text - Text to display
   * @param {string} type - Line type ('log', 'error', 'warning', 'success')
   */
   ...
   * @param {boolean} isIndeterminate - Whether to show indeterminate progress
   */
  setOutputIndeterminate(isIndeterminate = true) {
